...
# fire.iss installs these alongside the exe. A statically-linked fire.exe carries code from ~160
...
# Paths are repo-relative: LICENSE is at the root, the two notice documents live under docs/.
